...
<%@page import="in.co.sunrays.project3.dto.RoleDTO"%>
<%@page import="in.co.sunrays.proj3.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>

	<jsp:useBean id="dto" class="in.co.sunrays.project3.dto.RoleDTO" scope="request"></jsp:useBean>
	<jsp:useBean id="model" class="in.co.sunrays.proj3.model.RoleModelHibImp" scope="request"></jsp:useBean>
    ...
    if(list.size()>0){%>
           <div class="form-inline" >
				...
				<div class="form-group  text-center">
					...
					<%=HTMLUtility.getList("roleId", request.getParameter("roleId"), roleList) %>

...
public class EmailUtility {
	 ...
	 */
	     ...
	     */
	 public static ResourceBundle rb=ResourceBundle.getBundle("in.co.sunrays.proj3.bundle.system");
	 /**
	  * Email Server
	  */
	 public static final String SMTP_HOST_NAME=rb.getString("smtp.server");
	 /**
	  * Email Server Port
	  */
	 public static final String SMTP_PORT=rb.getString("smtp.port");
	 /**
	  ...
	  */
	 public static final String emailFromAddress=rb.getString("email.login");
	 /**
	  * Administrator email's password
	  */
	 public static final String emailPassword=rb.getString("email.pwd");
	 /**
	 ...
	 * @throws MessagingException 
	  */
	 public static void sendMail(EmailMessage emailMessageDTO) throws MessagingException
	 {
		 try
		 { 
			 ...
			 Session session= Session.getDefaultInstance(props, new javax.mail.Authenticator()
				     ...
				     protected javax.mail.PasswordAuthentication getPasswordAuthentication(){
				    	return new javax.mail.PasswordAuthentication(emailFromAddress, emailPassword); 
				     }
					 });
		 ...
		 }catch(MessagingException e)
		 {
			  ...
			  throw new MessagingException(" Because Internet Connection is not Available");
		 }
	 }

 ...
 %>
	 ...
	 <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
		...
		<%=ServletUtility.getErrorMessage("subjectId", request)%></label>
									...
									<div class="form-group" style="margin-left: 10%;">
										<label align="left" class="control-label col-md-6 text-info">
										 ...
										 <div class="col-md-12"  style="margin-bottom: 25px;">
											<div class="input-group">
												<span class="input-group-addon"> <i
													class="glyphicon glyphicon-time" aria-hidden="true"></i></span>
													<%
							...
							String examTimeList = HTMLUtility.getList("examTime", dto.getExamTime(), tmap);
						%> <%=examTimeList%>
											</div>
											<label class="control-label text-danger  error_msg" for="inputError1">
		...
		<input type="text" class="form-control" name="examDate"  id="datepicker2" readonly="readonly"
